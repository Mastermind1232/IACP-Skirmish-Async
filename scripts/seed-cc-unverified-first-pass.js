...
const firstPass = {
  ...
  'Stay Down': { cost: 2, playableBy: 'Biv Bodhrik', timing: 'afterSpecial', effect: 'Use after resolving "Close and Personal." If the target was not defeated, perform an additional attack with the same target. Then, you become Stunned.' },
  ...
  'Unlimited Power': { cost: 2, playableBy: 'Emperor Palpatine', timing: 'other', effect: 'Use when you use "Emperor." You may choose any other friendly figure on the map instead of another friendly figure within 4 spaces.' },
  ...
  'Trandoshan Terror': { cost: 2, playableBy: 'Bossk', timing: 'other', effect: "Use when you declare 'Indiscriminate Fire.' Add 1 yellow die to the dice pool." },
  ...
  'Windfall': { cost: 0, playableBy: 'Doctor Aphra', timing: 'other', effect: "Use when a Command card is discarded from your hand or deck. You gain VPs equal to that card's cost. When this card is discarded from your hand or deck, gain 1 VP." },
  ...
  'Wreak Vengeance': { cost: 1, playableBy: 'Maul', timing: 'other', effect: "Use when you use 'Dual-Bladed Fury.' You may choose both effects instead of only 1." },
