...
import {
  ...
  hasLineOfSightByCoord, hasFigureLineOfSight, getFigureFootprint, getAllFigureFootprints,
  resolveDcName, isFigurelessDc,
  dcNameFromFigureKey, parseFigureKey, getDcEffect, getEffectiveFigureSize,
  computeCombatResult, getEffectiveMapSpaces, getFiguresAdjacentToTarget, getFiguresAdjacentToCoord,
...
export function buildHeadlessDeps(options = {}) {
  ...
  const postPrototypeMovePrompt = noopAsync;
