 ...
 *   - "Marked Territory": needs an interior/exterior tile-type model (no map
 *     tags exterior spaces).
 ...
 */
export const UNIMPLEMENTED_CARDS = ['Set a Trap', 'Harsh Environment', "Smuggler's Tricks", 'Marked Territory'];
