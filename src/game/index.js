...
export { dcNameFromFigureKey, parseFigureKey, getDcEffect, isFigurelessDc, hasDepleteEffect, hasExhaustEffect, getCompanionDescriptionForDc, getMaxPowerTokens, buildFigureButtonLabel } from './dc-helpers.js';
