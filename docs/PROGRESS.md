...
| 🃏 CC Automation | 20 | 16.0 | 80% | 289/289 CC cards have library entries (100% coverage); 0 gameready, 12 testready, 141 wired, 83 partial, 53 unwired (manual) |
...
> Status hierarchy: **gameready** → **testready** → **wired** → **partial** → **unwired**
> 0 gameready · 12 testready · 141 wired · 83 partial · 53 unwired (manual)
...
- [ ] **53 CC cards are unwired (manual)** — no game state change; 47 post a logMessage reminder, 6 are fully silent
...
| 🟡 Medium | **53 unwired CC cards** | Medium | No game state change; 47 post a logMessage reminder, 6 are fully silent — all require manual resolution |
