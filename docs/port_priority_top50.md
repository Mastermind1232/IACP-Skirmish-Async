...
3. **adapt_blaise** — used by 1 DC(s): Agent Blaise
4. **adaptive_skills_mara_jade** — used by 1 DC(s): Mara Jade
5. **attached_dio** — used by 1 DC(s): Dio
6. **camouflage_mak** — used by 1 DC(s): Mak Eshka'rey
7. **camouflage_scout_trooper** — used by 1 DC(s): Scout Trooper (Elite)
8. **coordinated_hunt_purge_commander** — used by 1 DC(s): Purge Commander (Elite)
9. **defensive_fire_bokatan** — used by 1 DC(s): Bo-Katan Kryze
10. **devout_chirrut** — used by 1 DC(s): Chirrut Imwe
11. **dirty_dealing_bib** — used by 1 DC(s): Bib Fortuna
12. **droid_kit_iden** — used by 1 DC(s): Iden Versio
13. **dubious_counterparts_aphra** — used by 1 DC(s): Doctor Aphra
