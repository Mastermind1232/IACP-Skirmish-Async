...
const BATCH = [
  ...
  ['Against the Odds',     ['focusGainToUpToNFigures', 'vpCondition']],
  ['Eyes on the Prize',    ['eyesOnThePrize']],
  ['Gauntlet Blade',       ['rollOneDie', 'rollOneDieTarget', 'rollOneDieSurgeSelfPowerToken']],
